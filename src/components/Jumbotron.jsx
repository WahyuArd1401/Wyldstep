    ...
    <div className='w-full px-36 py-10 flex gap-8'>
      <div className='w-1/2 flex flex-col justify-around items-start my-10 px-8'>
        ...
        <div className='relative p-2 border border-custom-secondary'>
          <h1 className='text-5xl text-custom-secondary font-monument'>
            2022
          </h1>
      ...
      <div className='w-1/2 bg-[#F4F4F4] rounded-3xl relative aspect-square'>
        ...
        <img className="relative z-10 filter drop-shadow-[0_70px_30px_rgba(0,0,0,0.25)] -rotate-[10deg] transform -translate-x-10 -translate-y-10" src="../images/sneaker7.png" alt="Higlight Product" />
        <div className='absolute top-3/4 right-[90px] z-10'>
          ...
          <div className='flex justify-between items-center mt-3'>
            ...
            <button className='border border-black px-4 py-1 font-medium text-sm hover:text-custom-third hover:bg-custom-secondary hover:border-custom-secondary'>Buy Now</button>
          </div>
        </div>
      </div>
    </div>
